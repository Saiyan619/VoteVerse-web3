...
const AppContext = ({ children }) => {
  ...
  useEffect(() => {
    getCandidates(), getRemainingTime();
    getCurrentStatus();
  }, []);
  ...
  //Check if User has voted or not(User should be able to only vote once)
  const canVote = async () => {
  ...
  //The below two voting function was written only because the option are just 2
  ...
  //Get candidates(Options - Yes or No)
